import{dv as v,dQ as re,cG as c,cI as ce,cr as I,cs as L,cv as g,cw as k,cx as d,cu as l,cY as S,cR as D,d6 as h,ct as de,cz as _,cN as b,d4 as V,dL as he,dA as j,cK as F,de as E,cV as U,cC as ue,cH as O,dR as T,dI as J,d5 as pe,cB as ae,dS as me}from"./index-BW9rm6a1.js";import"./index-CVPwb2Oi.js";import{S as fe}from"./SwapController-DzTjlNlK.js";const ne={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){v.shake();return}if(await re.isSIWXCloseDisabled()){v.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ce.disconnect(),v.close()}},we=I`
  :host {
    display: block;
