import{c as L,a as _,i as I,p as P,O as h,R as w,D as T,x as c,m as b,F as U,G as F,H as R,j as l,q as S,I as D,y as u,J as k,k as C,K as N,M as O,T as $}from"./web3-D16o4WFR.js";import{n as j,r as d,b as M,o as x}from"./index-B_o_9Sdi.js";import"./charts-BK1r30At.js";import"./vendor-CpL4RcAy.js";const z=L`
  :host {
...
`;var v=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let m=class extends I{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=P.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=h.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(P.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(o=>o.type==="AUTH")}),h.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var i;let e=((i=this.remoteFeatures)==null?void 0:i.socials)||[];const o=!!this.authConnector,r=e==null?void 0:e.length,n=w.state.view==="ConnectSocials";return(!o||!r)&&!n?null:(n&&!r&&(e=T.DEFAULT_SOCIALS),c` <wui-flex flexDirection="column" gap="2">
      ${e.map(s=>c`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await M(e)}async handlePwaFrameLoad(){var e;if(b.isPWA()){this.isPwaLoading=!0;try{((e=this.authConnector)==null?void 0:e.provider)instanceof U&&await this.authConnector.provider.init()}catch(o){F.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:o.message},"error")}finally{this.isPwaLoading=!1}}}};m.styles=z;v([j()],m.prototype,"tabIdx",void 0);v([d()],m.prototype,"connectors",void 0);v([d()],m.prototype,"authConnector",void 0);v([d()],m.prototype,"remoteFeatures",void 0);v([d()],m.prototype,"isPwaLoading",void 0);m=v([_("w3m-social-login-list")],m);const q=L`
  wui-flex {
...
`;var W=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let E=class extends I{constructor(){super(),this.unsubscribe=[],this.checked=R.state.isLegalCheckboxChecked,this.unsubscribe.push(R.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var A;const{termsConditionsUrl:e,privacyPolicyUrl:o}=h.state,r=(A=h.state.features)==null?void 0:A.legalCheckbox,s=!!(e||o)&&!!r&&!this.checked,a=s?-1:void 0;return c`
    ...
    `}};E.styles=q;W([d()],E.prototype,"checked",void 0);E=W([_("w3m-connect-socials-view")],E);const B=L`
  wui-logo {
    width: 80px;
    height: 80px;
