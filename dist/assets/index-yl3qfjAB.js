...
`;var U=function(t,e,s,a){var r=arguments.length,i=r<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,s):a,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,s,a);else for(var d=t.length-1;d>=0;d--)(u=t[d])&&(i=(r<3?u(i):r>3?u(e,s,i):u(e,s))||i);return r>3&&i&&Object.defineProperty(e,s,i),i};const me=4e3;let I=class extends F{constructor(){super(),this.loadingMessage="",this.subMessage="",this.paymentState="in-progress",this.paymentState=l.state.isPaymentInProgress?"in-progress":"completed",this.updateMessages(),this.setupSubscription(),this.setupExchangeSubscription()}disconnectedCallback(){clearInterval(this.exchangeSubscription)}render(){return m`
    ...
    `}getPaymentIcon(){var s,a;const e=l.state.currentPayment;if(e){if(e.type==="exchange"){const r=e.exchangeId;if(r){const i=l.getExchangeById(r);return i==null?void 0:i.imageUrl}}if(e.type==="wallet"){const r=(a=(s=p.getAccountData())==null?void 0:s.connectedWalletInfo)==null?void 0:a.icon;if(r)return r;const i=p.state.activeChain;if(!i)return;const u=M.getConnectorId(i);if(!u)return;const d=M.getConnectorById(u);return d?Z.getConnectorImage(d):void 0}}}successTemplate(){return m`<wui-icon size="xl" color="success" name="checkmark"></wui-icon>`}errorTemplate(){return m`<wui-icon size="xl" color="error" name="close"></wui-icon>`}};I.styles=pe;U([h()],I.prototype,"loadingMessage",void 0);U([h()],I.prototype,"subMessage",void 0);U([h()],I.prototype,"paymentState",void 0);I=U([H("w3m-pay-loading-view")],I);const ye=3e5;async function he(t){return l.handleOpenPay(t)}async function _e(t,e=ye){if(e<=0)throw new c(o.INVALID_PAYMENT_CONFIG,"Timeout must be greater than 0");try{await he(t)}catch(s){throw s instanceof c?s:new c(o.UNABLE_TO_INITIATE_PAYMENT,s.message)}return new Promise((s,a)=>{let r=!1;const i=setTimeout(()=>{r||(r=!0,S(),a(new c(o.GENERIC_PAYMENT_ERROR,"Payment timeout")))},e);function u(){if(r)return;const f=l.state.currentPayment,k=l.state.error,K=l.state.isPaymentInProgress;if((f==null?void 0:f.status)==="SUCCESS"){r=!0,S(),clearTimeout(i),s({success:!0,result:f.result});return}if((f==null?void 0:f.status)==="FAILED"){r=!0,S(),clearTimeout(i),s({success:!1,error:k||"Payment failed"});return}k&&!K&&!f&&(r=!0,S(),clearTimeout(i),s({success:!1,error:k}))}const d=D("currentPayment",u),A=D("error",u),P=D("isPaymentInProgress",u),S=we([d,A,P]);u()})}function Te(){return l.getExchanges()}function Ce(){var t;return(t=l.state.currentPayment)==null?void 0:t.result}function Se(){return l.state.error}function be(){return l.state.isPaymentInProgress}function D(t,e){return l.subscribeKey(t,e)}function we(t){return()=>{t.forEach(e=>{try{e()}catch{}})}}const xe={network:"eip155:8453",asset:"native",metadata:{name:"Ethereum",symbol:"ETH",decimals:18}},Ue={network:"eip155:8453",asset:"0x833589fcd6edb6e08f4c7c32d4f71b54bda02913",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},ke={network:"eip155:84532",asset:"native",metadata:{name:"Ethereum",symbol:"ETH",decimals:18}},Re={network:"eip155:1",asset:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},ve={network:"eip155:10",asset:"0x0b2c639c533813f4aa9d7837caf62653d097ff85",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},De={network:"eip155:42161",asset:"0xaf88d065e77c8cC2239327C5EDb3A432268e5831",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},Oe={network:"eip155:137",asset:"0x3c499c542cef5e3811e1192ce70d8cc03d5c3359",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},Le={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},Me={network:"eip155:1",asset:"0xdAC17F958D2ee523a2206206994597C13D831ec7",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Ye={network:"eip155:10",asset:"0x94b008aA00579c1307B0EF2c499aD98a8ce58e58",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Ge={network:"eip155:42161",asset:"0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Ve={network:"eip155:137",asset:"0xc2132d05d31c914a87c6611c10748aeb04b58e8f",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},$e={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Be={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"native",metadata:{name:"Solana",symbol:"SOL",decimals:9}};export{I as W3mPayLoadingView,y as W3mPayView,De as arbitrumUSDC,Ge as arbitrumUSDT,xe as baseETH,ke as baseSepoliaETH,Ue as baseUSDC,Re as ethereumUSDC,Me as ethereumUSDT,Te as getExchanges,be as getIsPaymentInProgress,Se as getPayError,Ce as getPayResult,he as openPay,ve as optimismUSDC,Ye as optimismUSDT,_e as pay,Oe as polygonUSDC,Ve as polygonUSDT,Be as solanaSOL,Le as solanaUSDC,$e as solanaUSDT};
